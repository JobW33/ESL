...
add_parameter NONSENSE int 8 "idk what to write here"
set_parameter_property NONSENSE DISPLAY_NAME "variable name"
set_parameter_property NONSENSE GROUP "NANO Properties"
set_parameter_property NONSENSE AFFECTS_PORT_WIDTHS true
set_parameter_property NONSENSE ALLOWED_RANGES {1 2 4 8}
...
proc elaborate_me {}  {
  ...
  set the_led_width  [get_parameter_value NONSENSE]
